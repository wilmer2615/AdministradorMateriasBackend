...
namespace Logic.StudentLogic
{
    public class StudentLogic : IStudentLogic
    {
        ...
        {
            var entity = await this._studentRepository.AddAsync(_mapper.Map<Student>(studentDto));
        ...
        {
            var entity = await this._studentRepository.VerifyAccountAsync(accountDto.Email, accountDto.Password);
